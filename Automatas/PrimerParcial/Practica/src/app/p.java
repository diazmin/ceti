...
public class p {
    ...
    public static void caracteres(String texto) throws FileNotFoundException {
        ...
        } // catch (FileNotFoundException e) {System.out.println("No se encontró el
          // archivo .txt");}
     ...
     public static void enviarConGMail(String destinatario, String asunto, String cuerpo) {
        ...
        // Esto es lo que va delante de @gmail.com en tu cuenta de correo. Es el
         ...
         try {
             ...
             message.setRecipients(Message.RecipientType.TO, destinatario); // Se podrían añadir varios de la misma manera
